...
my_dir = Path(str(data_dir) + "/intercomp/" + f"intercomp-{day2_obs_date}-{domain}.zarr")
if my_dir.is_dir():
    intercomp_yesterday = xr.open_zarr(str(data_dir) + "/intercomp/" + f"intercomp-{day2_obs_date}-{domain}.zarr")
    ...
    final_ds.to_zarr(str(data_dir) + "/intercomp/" + f"intercomp-{day1_obs_date}-{domain}.zarr", "w")
else:
