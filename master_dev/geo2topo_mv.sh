...
for filename in /bluesky/fireweather/fwf/data/geojson/$(date '+%Y%m%d00')/wsp*.geojson; do
    /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 wsp="$filename" > "/bluesky/archive/fireweather/forecasts/$(date '+%Y%m%d00')/$(basename "$filename" .geojson).json"
done
...
for filename in /bluesky/fireweather/fwf/data/geojson/$(date '+%Y%m%d00')/temp*.geojson; do
    /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 temp="$filename" > "/bluesky/archive/fireweather/forecasts/$(date '+%Y%m%d00')/$(basename "$filename" .geojson).json"
done
...
for filename in /bluesky/fireweather/fwf/data/geojson/$(date '+%Y%m%d00')/rh*.geojson; do
    /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 rh="$filename" > "/bluesky/archive/fireweather/forecasts/$(date '+%Y%m%d00')/$(basename "$filename" .geojson).json"
done
...
for filename in /bluesky/fireweather/fwf/data/geojson/$(date '+%Y%m%d00')/qpf-*.geojson; do
    /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 qpf="$filename" > "/bluesky/archive/fireweather/forecasts/$(date '+%Y%m%d00')/$(basename "$filename" .geojson).json"
done
