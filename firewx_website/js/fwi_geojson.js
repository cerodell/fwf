function geo_json_fwi_styler(feature) {
...
function geo_json_fwi_onEachFeature(feature, layer) {};


var geo_json_fwi = L.geoJson(null, {
        onEachFeature: geo_json_fwi_onEachFeature,
    
        style: geo_json_fwi_styler,
}).addTo(map_fwi);




function geo_json_fwi_add (data) {
