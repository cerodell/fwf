...
function geo_json_isi_styler(feature) {
...
function geo_json_isi_onEachFeature(feature, layer) {};

var geo_json_isi = L.geoJson(null, {
        onEachFeature: geo_json_isi_onEachFeature,
    
        style: geo_json_isi_styler,
}).addTo(map_fwi);




function geo_json_isi_add (data) {
    geo_json_isi.addData(data);
};
