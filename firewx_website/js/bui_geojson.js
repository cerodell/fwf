function geo_json_bui_styler(feature) {
...
function geo_json_bui_onEachFeature(feature, layer) {};


var geo_json_bui = L.geoJson(null, {
        onEachFeature: geo_json_bui_onEachFeature,
    
        style: geo_json_bui_styler,
}).addTo(map_fwi);




function geo_json_bui_add (data) {
