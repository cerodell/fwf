...
with open('/Users/rodell/fwf/leaflet/python/basemaps.json') as f:
  basemaps = json.load(f)
with open('/Users/rodell/fwf/leaflet/python/colormaps.json') as f:
  cmaps = json.load(f)
...
# # # Plot the data
fwimap.save(str(leaflet_dir) + '/html/multi_layer_all.html')
