...
class FWF:
    ...
    def solve_fwi(self, hourly):
        ...
        if hourly == True:
            ...
            U["time"] = [self.daily_ds.Time.values]
    ...
    def find_daily_extreme(self, houlry_ds, daily_ds, var_list):
        ...
        for j in range(len(index)):
            ...
            for i in range(index[j], index[j] + 24):
                ...
                # print(ind_a.south_north.values)
    ...
    def hourly(self):
        ...
        # h1600_ds = self.get_noon(hourly_ds, ["F", "R", "S"], carryover_rain=False, offset_noon = 4)
        # print('max_ds', list(max_ds))
        # print('noon_ds', list(noon_ds))
        # print('h1600_ds', list(h1600_ds))
        ...
        if self.file_formate == "netcdf":
            ...
            bashComand = "rm -rf ._*"
            os.system(bashComand)
            # hourly_ds['Time'] = hourly_ds['Time'].chunk('auto')
            # hourly_ds['time'] = hourly_ds['time'].chunk('auto')
            hourly_ds = hourly_ds.drop_vars("time")
            hourly_ds = self.rechunk(hourly_ds)
            # del hourly_ds
            # del self.hourly_ds
