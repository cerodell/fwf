...
def plot_bias(var, df_wmo, ax):
    ...
    axins.set_xlabel(var_lower.title(), fontsize=20)
    axins.set_ylabel("Count", fontsize=20)
...
########################
ax = plt.subplot(gs[0])
ax.set_title("WRF 4-km", fontsize=22)
ax.annotate(
    "A)", xy=(-0.05, 1.04), xycoords="axes fraction", fontsize=22, fontweight="bold"
)
ax.set_xticklabels([])
sc = plot_bias(var, df_wmo_d03, ax)
ax.set_ylabel("Station Elevation (m)", fontsize=22)
ax.tick_params(axis="both", labelsize=22)

########################
ax = plt.subplot(gs[1])
ax.set_title("WRF 12-km", fontsize=22)
ax.annotate(
...
sc = plot_bias(var, df_wmo_d03, ax)
ax.set_xlabel("Model Elevation (m)", fontsize=22)
ax.set_ylabel("Station Elevation (m)", fontsize=22)
ax.tick_params(axis="both", labelsize=22)
