...
wrf_d03_max = f"WRF 4km Max                {get_mbe(day1_df, 'd03-max')},             {get_mbe(day2_df, 'd03-max')}"
...
wrf_d02_max = f"WRF 12km Max              {get_mbe(day1_df, 'd02-max')},             {get_mbe(day2_df, 'd02-max')}"
...
hrdps_max = f"HRDPS 2.5km Max          {get_mbe(day1_df, 'hrdps-max')},             {get_mbe(day2_df, 'hrdps-max')}"
...
rdps_max = f"RDPS 10km Max              {get_mbe(day1_df, 'rdps-max')},             {get_mbe(day2_df, 'rdps-max')}"
