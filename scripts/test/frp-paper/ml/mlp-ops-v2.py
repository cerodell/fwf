...
def predict_frp(doi, domain, mlp_test_case):
    ...
    fwf_ds["R_hour_sin"] = hour_sin * fwf_ds["R"]
    fwf_ds["R_hour_cos"] = hour_cos * fwf_ds["R"]
    fwf_ds["S_hour_sin"] = hour_sin * fwf_ds["S"]
    fwf_ds["S_hour_cos"] = hour_cos * fwf_ds["S"]
    ...
    fwf_ds["R_hour_sin_Dead_Foliage"] = fwf_ds["R"] * hour_sin * fwf_ds["Dead_Foliage"]
    fwf_ds["R_hour_cos_Dead_Foliage"] = fwf_ds["R"] * hour_cos * fwf_ds["Dead_Foliage"]
