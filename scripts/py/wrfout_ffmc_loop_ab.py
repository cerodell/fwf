...
save = '/Users/rodell/Google Drive File Stream/Shared drives/Research/CRodell/Model/Images/FFMC/Contour/AB/'+wrf_date +'/'+date_time+'/'
...
#    i = 5
    ...
    plt.title(r"Fine Fuel Moisture Code" + "\n" + r"Init:    " +  path_str[0][-19:-3] + "Z""\n" +"Valid: " + path_str[i][-19:-3]+"Z", loc='left')
