...
for domain in ["d02", "d03"]:
    ...
    lngs = daily_ds.XLONG.values
    lats = daily_ds.XLAT.values
    ...
    # print(f"{str(datetime.now())} ---> start loop of daily fwf products for domain {domain}")
    # try:
    ...
    # except:
    #     mycontourf_to_geojson(
    #         cmaps, "P", daily_ds, -99, folderdate, "colors18", domain, nested_index
    #     )
    #     mycontourf_to_geojson(
    #         cmaps, "D", daily_ds, -99, folderdate, "colors18", domain, nested_index
    #     )
    #     mycontourf_to_geojson(
    #         cmaps, "U", daily_ds, -99, folderdate, "colors18", domain, nested_index
    #     )

    # print(f"{str(datetime.now())} ---> end loop of daily fwf products for domain {domain}")
