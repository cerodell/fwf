...
ffmc = np.array(hourly_ds.F, dtype = '<U8')
isi = np.array(hourly_ds.R, dtype = '<U8')
fwi = np.array(hourly_ds.S, dtype = '<U8')
dsr = np.array(hourly_ds.DSR, dtype = '<U8')
dmc = np.array(daily_ds.P, dtype = '<U8')
dc = np.array(daily_ds.D, dtype = '<U8')
bui = np.array(daily_ds.U, dtype = '<U8')
