...
# geobuf decode < ffmc-2020083000.pbf > example.pbf.json
# geobuf encode < ffmc-2020083000-test.geojson > ffmc-2020083000-test.pbf
# # cd /bluesky/fireweather/fwf/data/geojson/2020083000/
# /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 FFMC=ffmc-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/ffmc-2020083000.json
# # /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 ISI=isi-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/isi-2020083000.json
# # /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 FWI=fwi-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/fwi-2020083000.json
...
# gzip < ffmc-2020083000.json > ffmc-2020083000.json.gz
# gzip -9 < ffmc-2020083000.pbf > ffmc-2020083000.pbf.gz
# tippecanoe -zg -o ffmc-2020083000-42.mbtiles --drop-densest-as-needed ffmc-2020083000.geojson
# tippecanoe -zg -o ffmc-2020083000-extended-zooms.mbtiles --extend-zooms-if-still-dropping ffmc-2020083000.geojson
# tippecanoe -o ffmc-2020083000-zz.mbtiles ffmc-2020083000.json
# tippecanoe -zg -o ffmc-2020083000-blah.mbtiles --drop-densest-as-needed ffmc-2020083000.json
# tippecanoe -o ffmc-2020083000-blah.mbtiles --detect-shared-borders ffmc-2020083000.json
## Convert FFMC to topojson and move to website directory
# /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 wsp=wsp-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/wsp-2020083000.json
# /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 temp=temp-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/temp-2020083000.json
# /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 rh=rh-2020083000.geojson > /bluesky/fireweather/fwf/web_dev/data/rh-2020083000.json


for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/ffmc*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/dmc*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/dc*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/isi*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/bui*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/fwi*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/wsp*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/temp*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/rh*.geojson; do
...
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/qpf-*.geojson; do
...
## Convert total accumulated precip to topojson and move to website directory
for filename in /bluesky/fireweather/fwf/data/geojson/2020083000/qpf_3h*.geojson; do
    /bluesky/fireweather/fwf/node_modules/topojson-server/bin/geo2topo -q 1e4 qpf="$filename" > "/bluesky/fireweather/fwf/web_dev/data/$(basename "$filename" .geojson).json"
done
