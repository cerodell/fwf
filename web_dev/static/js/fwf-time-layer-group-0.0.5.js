      ...
      return (
          ...
          "SFC" == this._thisVar &&
              fetch(t, { cache: "default" })
                  ...
                  .then(function (e) {
                      r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { sfc: geo_json_styler_fbp } }).setZIndex(500));
                  }),
          "TFC" == this._thisVar &&
              fetch(t, { cache: "default" })
                  .then(function (e) {
          ...
          "wsp" == this._thisVar &&
              fetch(t, { cache: "default" })
                  ...
                  .then(function (e) {
                      r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { wsp: geo_json_styler_wsp } }).setZIndex(900));
                  }),
          "temp" == this._thisVar &&
              fetch(t, { cache: "default" })
                  .then(function (e) {
