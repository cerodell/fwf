...
(L.TimeDimension.Layer.LayerGroup = L.TimeDimension.Layer.extend({
    ...
    _update: function () {
        if (this._map) {
            ...
            null == this._currentLayer && ((this._currentLayer = t), this._showLayer(t, e)), this._map.hasLayer(t) || this._map.addLayer(t), this._showLayer(t, e);
        }
    },
    ...
    _evictCachedTimes: function (e, t) {
        var r,
            ...
            a = i.indexOf(n),
            o = [];
        t > -1 && (r = a - t) > 0 && ((o = i.splice(0, r)), this._removeLayers(o)), e > -1 && ((a = i.indexOf(n)), (r = i.length - a - e - 1) > 0 && ((o = i.splice(a + e + 1, r)), this._removeLayers(o)));
    },
    _showLayer: function (e, t) {
        this._currentLayer && this._currentLayer !== e && this._currentLayer.hide(),
            ...
            (this._currentLayer && this._currentLayer === e) ||
                ...
                (UTCTimeMap = (UTCTimeMap = new Date(t).toISOString()).slice(0, 19)),
    ...
    _getLayerForTime: function (e) {
        ...
        return (
            ...
            fetch(t, { cache: "default" })
                ...
                .then(function (e) {
                    r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { FRP: geo_json_styler_frp } }).setZIndex(500));
                }),
            "FFMC" == this._thisVar &&
                fetch(t, { cache: "default" })
                    .then(function (e) {
            ...
            "HFI" == this._thisVar &&
                fetch(t, { cache: "default" })
                    ...
                    .then(function (e) {
                        r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { hfi: geo_json_styler_hfi } }).setZIndex(500));
                    }),
            "ROS" == this._thisVar &&
                fetch(t, { cache: "default" })
                    .then(function (e) {
                    ...
                    .then(function (e) {
                        r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { ros: geo_json_styler_fbp } }).setZIndex(500));
                    }),
            "CFB" == this._thisVar &&
                fetch(t, { cache: "default" })
                    .then(function (e) {
                    ...
                    .then(function (e) {
                        r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { cfb: geo_json_styler_fbp } }).setZIndex(500));
                    }),
            "TFC" == this._thisVar &&
                fetch(t, { cache: "default" })
                    .then(function (e) {
                    ...
                    .then(function (e) {
                        r.addLayer(L.vectorGrid.slicer(e, { minZoom: 2, maxZoom: 18, rendererFactory: L.canvas.tile, vectorTileLayerStyles: { tfc: geo_json_styler_fbp } }).setZIndex(500));
                    }),
            "wsp" == this._thisVar &&
                fetch(t, { cache: "default" })
                    .then(function (e) {
                ...
                fetch(t, { cache: "default" })
                    ...
                    .then(function (e) {
                        r.addLayer(
                            L.velocityLayer({
                                displayValues: !0,
                                displayOptions: { velocityType: "Wind", position: "bottomleft", emptyString: "No wind data", speedUnit: "k/h", angleConvention: "meteo" },
                                data: e,
                                maxVelocity: 15,
                                colorScale: ["#kkk"],
                            })
    ...
    (dateFileName = function (e) {
        return (YYYYMMDD = e.getUTCFullYear().toString()), (YYYYMMDD += pad2(e.getUTCMonth() + 1).toString()), (YYYYMMDD += pad2(e.getUTCDate()).toString());
    }),
    (dateTimeFileName = function (e) {
        return (YYYYMMDDhhmm = e.getUTCFullYear().toString()), (YYYYMMDDhhmm += pad2(e.getUTCMonth() + 1).toString()), (YYYYMMDDhhmm += pad2(e.getUTCDate()).toString()), (YYYYMMDDhhmm += pad2(e.getUTCHours()).toString());
    }),
    (getHourlyForecast = function (e, t) {
        var r,
            i = e.substring(0, e.lastIndexOf("/"));
        return (url = i + e.substring(e.lastIndexOf("/"), e.length - 16) + "-" + dateTimeFileName(new Date(t)) + ".json"), console.log(url), url;
    }),
    (getDailyForecast = function (e, t) {
        var r,
            i = e.substring(0, e.lastIndexOf("/"));
        return (url = i + e.substring(e.lastIndexOf("/"), e.length - 14) + "-" + dateFileName(new Date(t)) + ".json");
    });
