...
legend_radar.onAdd = function (map) {
    var div = L.DomUtil.create('div', 'info legend');
    div.innerHTML += '<img src="https://geo.weather.gc.ca/geomet?version=1.3.0&service=WMS&request=GetLegendGraphic&sld_version=1.1.0&layer=RADAR_1KM_RRAI&format=image/png&STYLE=RADARURPPRECIPR14-LINEAR" alt="Legend">';
    return div;
};
...
color_map_sfc.onAdd = function (t) {
  var d = L.DomUtil.create("div", "fcst-legend leaflet-bar leaflet-control");
  return (
      (d.innerHTML =
          '<table id="values"><tr id="colours"><td style="background:#0000ff; width:30px; border-left:none;"></td><td style="background:#008001; width:30px;"></td><td style="background:#01e001; width:30px;"></td><td style="background:#ffff00; width:30px;"></td><td style="background:#dfa000; width:30px;"></td><td style="background:#ff0000; width:30px;"></td><td style="background:#8b0000; width:30px;"></td></tr><tr id="ticks"><td style="width:10px; border-left:none;"></td><td></td><td></td><td></td><td></td><td></td><td></td></tr></table><table id="labels"><tr><td width="2px">0</td><td width="46px">1</td><td width="17px">2</td><td width="44px">3</td><td width="18px">4</td><td width="44px">5</td><td width="26px">6+</td></tr></table><div class="legend-title">Surface Fuel Consumption (kg/m<sup>2</sup>)</div>'),
      d
  );
};
...
map.on("overlayremove", function (t) {
  ...
  map.on("overlayadd", function (t) {
      t.layer == sfcTimeLayer && color_map_sfc.addTo(map);
  }),
  map.on("overlayremove", function (t) {
      t.layer == sfcTimeLayer && color_map_sfc.remove(map);
  }),
  map.on("overlayadd", function (t) {
