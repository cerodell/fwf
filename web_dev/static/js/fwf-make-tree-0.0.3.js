...
const control = new searchboxControl({
    ...
    sidebarMenuItems: {
        Items: [
            ...
            { type: "link", name: "fwf-daily-d02", href: "arc/fwf-hourly-d02-2021022306.tgz", download:"test", icon: "icon-data"},
            { type: "link", name: "fwf-hourly-d02", href: "arc/fwf-hourly-d02-"+ filedate+".nc", download:"test", icon: "icon-data"},
            { type: "link", name: "fwf-daily-d03", href: "arc/fwf-daily-d03-"+ filedate+".nc", download:"test", icon: "icon-data"},
            { type: "link", name: "fwf-hourly-d03", href: "arc/fwf-hourly-d03-"+ filedate+".nc", download:"test", icon: "icon-data"},
