...
function makeplotly(e) {
        btn_fire2.onclick = ObjectFun.fwiplot(e);
        btn_wx2.onclick = ObjectFun.wxplot(e);
        btn_fbp.onclick = ObjectFun.fbpplot(e);
};


function makeplotly3(e) {
    btn_fire3.onclick = ObjectFun.fwiplot(e);
    btn_wx3.onclick = ObjectFun.wxplot(e);
    btn_fbp3.onclick = ObjectFun.fbpplot(e);
    ObjectFun.fwiplot(e);
};
                ...
                if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
                    ...
                    map.on(activate, function (o) {
                        ...
                        if ( _ == 'd3'){
                                ...
                                fwfmodellocation = new L.marker([ww,vv],{icon: redIcon, customId: zone_json_d3, customIdx: hh, customDiv: 'wx_plot2'});
                            ...
                            fwfmodellocation = new L.marker([w,v],{icon: redIcon, customId: zone_json, customIdx: h, customDiv: 'wx_plot2'});
                            fwfmodellocation.bindPopup(div2, {maxWidth: "auto", maxHeight: "auto"});
                            fwfmodellocation.setZIndexOffset(1000);
                        ...
                        if ( _ == 'd3'){
                                ...
                                console.log(zone_json_d3);
                                makeplotly3({customId: zone_json_d3, customIdx: hh, lat: ww, lng: vv, customDiv: 'wx_plot3'});
                            ...
                            console.log(zone_json);
                            makeplotly3({customId: zone_json, customIdx: h, lat: w, lng: v, customDiv: 'wx_plot3'});
                            });
                            loaded_zones.push(_);
